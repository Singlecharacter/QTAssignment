...
public:
    ...
    void setupUi(QWidget *SortDialog)
    {
        ...
        SortDialog->resize(306, 404);
        widget = new QWidget(SortDialog);
        widget->setObjectName(QStringLiteral("widget"));
        widget->setGeometry(QRect(10, 10, 289, 387));
        ...
        gridLayout_4->addWidget(tertiaryGroupBox, 4, 0, 1, 1);
    ...
    {
        SortDialog->setWindowTitle(QApplication::translate("SortDialog", "Form", 0));
        ...
        tertiaryGroupBox->setTitle(QApplication::translate("SortDialog", "&TertiaryKey", 0));
